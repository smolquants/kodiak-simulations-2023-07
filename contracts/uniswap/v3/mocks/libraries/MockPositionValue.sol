...
import {MockPoolAddress as PoolAddress} from "./MockPoolAddress.sol";
import {IMockNonfungiblePositionManager as INonfungiblePositionManager} from "../interfaces/IMockNonfungiblePositionManager.sol";
...
library MockPositionValue {
    ...
    function fees(address manager, uint256 tokenId) internal view returns (uint256 amount0, uint256 amount1) {
        INonfungiblePositionManager positionManager = INonfungiblePositionManager(manager);
        (
            ,
            ,
